...
set output "chull.pdf"
set title "SpaceEx STC with Convex Hull Aggregation" font 'Verdana,22' offset 0,-1

set style line 5 lc rgb "#808080" lt 2 lw 2.0 pt 13 ps 0.8 dt 2
set arrow from 0, 50 to 75, 50 nohead ls 5
set label 21 "Timeout (One Minute)" at 5,50 font 'Verdana,14' tc rgb "#808080" offset 0, -0.4
