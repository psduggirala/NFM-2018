...
\begin{minipage}[b]{\linewidth}
  \centering
    \includegraphics[width=0.8\columnwidth,trim=-7em 1em 7em 0, clip]{images/spaceex.png}
...
\begin{minipage}[b]{\linewidth}
  \centering
    \includegraphics[width=0.8\columnwidth,trim=0 1.5em 0 0, clip]{images/step_d_0_25.png}
\subcaption{Our implementation (discrete time)}\label{fig:hylaa_qualitative}
\end{minipage}
\caption{{\footnotesize The reachability plots using SpaceEx (top) in continuous time and our implementation based off Hylaa (bottom) in discrete time are qualitatively similar.
...
\begin{minipage}[b]{\linewidth}
  \centering
  \includegraphics[width=0.8\columnwidth,trim=0 1.3em 0 0, clip]{images/step_a_1_0.png}
...
\begin{minipage}[b]{\linewidth}
  \centering
    \includegraphics[width=0.8\columnwidth,trim=0 1.3em 0 0, clip]{images/step_b_0_5.png}
...
\begin{minipage}[b]{\linewidth}
  \centering
    \includegraphics[width=0.8\columnwidth,trim=0 1.3em 0 0, clip]{images/step_c_0_25.png}
...
\begin{minipage}[b]{\linewidth}
  \centering
    \includegraphics[width=0.8\columnwidth,trim=0 1.3em 0 0, clip]{images/deagg_1_0.png}
...
\vspace{-0.2cm}
\caption{{\footnotesize The reachable set for the spacecraft rendezvous system at three different zoom levels is shown.
