...
In this paper, we perform safety analysis of \new{two case studies, a satellite rendezvous mission and a gearbox meshing} modeled as a hybrid automata.
%
...
\new{The two case studies considered in this paper, satellite rendezvous and gearbox meshing, present significant challenge in handling the discrete transitions.}
